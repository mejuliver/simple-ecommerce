				...
				<div class="box bg-white">
					<form action="" x-data="data()" @submit.prevent="submit" class="row">
						<div class="col-12">
							...
							<div class="mt24 mb24">	
								<button class="btn-block btn btn-primary" :disabled="data.is_saving" x-text="data.is_saving ? 'SUBMITTING...' : 'LOGIN' "></button>
							</div>
						</div>
						<div class="col-12">
							<div class="row">
			...
			submit(){
				...
				.then(res=>{
					if( app_utility.redirect_url && app_utility.redirect_url != '' ){
						...
						location.replace(app_utility.base_url+'/account');
					}
				})
				.catch(err=>{
					console.log(err);

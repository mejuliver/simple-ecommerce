		...
		<div class="row mt44 mb44 d-flex align-items-center">
			...
			<div class="col-5">	
				<div class="box bg-white">
					<form action="" x-data="register()" @submit.prevent="submit" class="row">
						<div class="col-12">
							<h3>REGISTER</h3>
							<div class="input-box">
								<input type="text" x-model="data.first_name" placeholder="first name" name="first_name" class="form-control" :disabled="data.is_saving">
							</div>
							<div class="input-box">
								<input type="text" x-model="data.last_name" placeholder="last name" name="last_name" class="form-control" :disabled="data.is_saving">
							</div>
							<div class="input-box">
							...
							<div class="input-box">
								<span class="password-eye" @click="data.show_password = !data.show_password ? true : false" x-text="data.show_password ? 'hide' : 'show'"></span>
								<input :type="data.show_password ? 'text' : 'password'" x-model="data.confirm_password" placeholder="confirm password" name="confirm_password" class="form-control" :disabled="data.is_saving">
							</div>
							<div class="mt24 mb24">	
								<button class="btn-block btn btn-primary" :disabled="data.is_saving" x-text="data.is_saving ? 'SUBMITTING...' : 'REGISTER' "></button>
							</div>
						</div>
						<div class="col-12">
							<div class="row">
	...
	function register(){
		return {
			...
			validateForm(){
				...
				if( this.$store.utility.isEmpty(this.data.first_name) ){
